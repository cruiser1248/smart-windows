...
/**
 * Affiliatedfacilitykey entity. @author MyEclipse Persistence Tools
 */

public class Affiliatedfacilitykey implements java.io.Serializable {
	...
	/** default constructor */
	public Affiliatedfacilitykey() {
	}

	/** minimal constructor */
	public Affiliatedfacilitykey(String status, String value) {
		this.status = status;
		this.value = value;
	}

	/** full constructor */
	public Affiliatedfacilitykey(Mainfacility mainfacility, String status,
